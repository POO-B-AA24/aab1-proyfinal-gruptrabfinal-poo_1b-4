...
public class ListaAdministracionCompleta extends javax.swing.JPanel {
    ...
    public void mostrarTabla(){
        ...
        for (EmpleadoAdministracion emp: listaAdministracion) 
            this.modelo.addRow(new Object[]{emp.numAdministracion, emp.getNombreCompleto(), 
                ...
                emp.getFechaContratacion(), emp.getAniosTrabajados(), emp.getNivelAcademico(), 
                emp.getHabilidadesBlandas(), emp.getIdiomasHablados(), emp.getCertificadosAdicionales()});
    }

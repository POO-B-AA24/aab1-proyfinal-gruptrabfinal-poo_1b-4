...
public class ListaPPL_P2 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("PABELLON 2: \"SOMBRA\" - TIPO: MEDIA PELIGROSIDAD");
    ...
    public void mostrarTabla(){
        ...
        ArrayList<PPL> listaPPL2 = new ArrayList<PPL>();
        ArrayList<PPL> listaPPLaux = new ArrayList<PPL>();
        SistemaAdministracionCarcel sistema = new SistemaAdministracionCarcel();
        listaPPL2 = sistema.getListaPabellones().get(1).getListaPPL();
        listaPPLaux = sistema.cambiarNumeracionPPL(listaPPL2);

...
public class ListaPPL_P4 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("PABELLON 4: \"REDENCION\" - TIPO: BAJA PELIGROSIDAD");
    ...
    public void mostrarTabla(){
        ...
        ArrayList<PPL> listaPPL4 = new ArrayList<PPL>();
        ArrayList<PPL> listaPPLaux = new ArrayList<PPL>();
        SistemaAdministracionCarcel sistema = new SistemaAdministracionCarcel();
        listaPPL4 = sistema.getListaPabellones().get(3).getListaPPL();
        listaPPLaux = sistema.cambiarNumeracionPPL(listaPPL4);
        for (PPL ppl : listaPPLaux) 
            this.modelo.addRow(new Object[]{ppl.numPPL, ppl.getNombreCompleto(), 
                ppl.getCedula(), ppl.getEdad(), ppl.getLugarNacimiento(), ppl.getGenero(), ppl.getAlias(), 
                ppl.getClasificacion(), ppl.getCelda(), ppl.getPabellon(), ppl.getFechaIngreso(), 
                ppl.getFechaSalida(), ppl.getPenaAsignada(), ppl.getAniosRestantes(), 
                ppl.getDelitoCometido(), ppl.getVisitasSemanales()});
    }

...
public class ListaSeguridadCompleta extends javax.swing.JPanel {
    DefaultTableModel modelo;
    
    public ListaSeguridadCompleta() {
        initComponents();
    ...
    private void initComponents() {
        ...
        if (listaCompleta.getColumnModel().getColumnCount() > 0) {
            ...
            listaCompleta.getColumnModel().getColumn(7).setPreferredWidth(70);
            listaCompleta.getColumnModel().getColumn(9).setPreferredWidth(70);
            listaCompleta.getColumnModel().getColumn(13).setPreferredWidth(130);
        }
    ...
    public void mostrarTabla(){
        ...
        for (EmpleadoSeguridad emp: listaSeguridad) 
            this.modelo.addRow(new Object[]{emp.numSeguridad, emp.getNombreCompleto(), 
                emp.getCedula(), emp.getEdad(), emp.getLugarNacimiento(), emp.getGenero(), emp.getCargo(), 
                emp.getSalario(), emp.getHorasTrabajadas(), emp.getValorXHora(), emp.getTelefonoContacto(), 
                emp.getFechaContratacion(), emp.getAniosTrabajados(), emp.getPabellon(), 
                emp.getTipoLicenciaArma(), emp.getNivelEntrenamiento(), emp.getLimitanteFisico(),
                emp.getEquipoProteccion()});
    }

...
public class Lista_Seguridad_Pab1 extends javax.swing.JPanel {
    DefaultTableModel modelo;
    
    public Lista_Seguridad_Pab1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("LISTA DE EMPLEADOS DE SEGURIDAD  -  PABELLON \"INQUISICION\" - MAXIMA PELIGROSIDAD");
    ...
    public void mostrarTabla(){
        ...
        listaSeguridad = sistema.getListaPabellones().get(0).getListaEmpleadoSeguridad();

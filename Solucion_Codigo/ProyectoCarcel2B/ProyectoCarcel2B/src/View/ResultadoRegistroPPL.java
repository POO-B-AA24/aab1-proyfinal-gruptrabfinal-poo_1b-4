...
public class ResultadoRegistroPPL extends javax.swing.JPanel {
    private String mensaje;
    public ResultadoRegistroPPL(PPL ppl) {
        initComponents();
        insertar(ppl);
    }
    ...
    public void insertar(PPL ppl){
        SistemaAdministracionCarcel sistema = new SistemaAdministracionCarcel();
        if(sistema.verificarCupoPPL()){
            sistema.insertarPPL(ppl);
            cajita.setText("PPL INGRESADO CON EXITO A LA BASE DE DATOS");
        }else{
            cajita.setText("LO SENTIMOS, EN ESTE MOMENTO NO EXISTEN CUPOS DISPONIBLES");
        }

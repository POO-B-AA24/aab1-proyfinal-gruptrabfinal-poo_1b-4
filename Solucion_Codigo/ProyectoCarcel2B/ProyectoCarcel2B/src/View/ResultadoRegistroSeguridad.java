...
public class ResultadoRegistroSeguridad extends javax.swing.JPanel {
    private String mensaje;
    public ResultadoRegistroSeguridad(EmpleadoSeguridad emp) {
        initComponents();
        insertar(emp);
    }
    ...
    public void insertar(EmpleadoSeguridad emp){
        SistemaAdministracionCarcel sistema = new SistemaAdministracionCarcel();
        sistema.insertarEmplseguridad(emp);

...
public class VentanaEmpleados extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addContainerGap())
            .addComponent(dinamico, javax.swing.GroupLayout.DEFAULT_SIZE, 983, Short.MAX_VALUE)
        );
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        SeleccionarRegistroEmpleados panel = new SeleccionarRegistroEmpleados();
        panel.setSize(940, 450);
        panel.setLocation(13, 0);
        
        dinamico.removeAll();
        dinamico.add(panel, BorderLayout.CENTER);
        dinamico.revalidate();
        dinamico.repaint();

...
public class VentanaPPL extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addContainerGap())
            .addComponent(dinamico, javax.swing.GroupLayout.DEFAULT_SIZE, 981, Short.MAX_VALUE)
        );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        SeleccionarListaPPL seleccionar = new SeleccionarListaPPL();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        EstadisticaPPL panelEst = new EstadisticaPPL();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        RegistrarPPL registro = new RegistrarPPL();
        registro.setSize(940, 450);
        registro.setLocation(13, 0);
        
        dinamico.removeAll();
        dinamico.add(registro, BorderLayout.CENTER);
        dinamico.revalidate();
        dinamico.repaint();
